...
/**
 * A resource storing a {@link RPYPackage}
 * 
 * @author sylvain
 *
 */
@ModelEntity
@ImplementationClass(RPYPackageResourceImpl.class)
public interface RPYPackageResource extends RPYResource<RPYPackage, RPYPackageFactory> {

	/**
	 * Returns the package name this resource stores.<br>
