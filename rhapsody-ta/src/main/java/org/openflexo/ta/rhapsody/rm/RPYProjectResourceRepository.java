...
/**
 * Rhapsody project resource repository<br>
 * 
 * A repository which references some {@link RPYProject}
 * 
 * @author sylvain
 * 
 */
@ModelEntity
public interface RPYProjectResourceRepository<I>
		extends TechnologyAdapterResourceRepository<RPYProjectResource, RPYTechnologyAdapter, RPYProject, I> {
