...
/**
 * A resource storing a Rhapsody project
 * 
 * @author sylvain
 *
 */
@ModelEntity
@ImplementationClass(RPYProjectResourceImpl.class)
public interface RPYProjectResource extends RPYResource<RPYProject, RPYProjectFactory>, DirectoryContainerResource<RPYProject> {
	 ...
	 * @return
	 */
	// public List<RPYResource> getBComponentResources();
}
