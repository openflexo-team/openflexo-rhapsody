...
/**
 * This class provides the parsing service for Rhapsody files.<br>
 * This includes syntactic and semantics analyzer.<br>
 * 
 * SableCC is used to generate the grammar located in rhapsody-ta-parser.<br>
 * 
 * @author sylvain
 */
public class RPYParser {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(RPYParser.class.getPackage().getName());

	/**
	 * This is the method to invoke to perform a parsing.<br>
	 * Syntaxic and semantics analyzer are performed and returned value is a {@link RPYProject}
	 * 
	 * @param inputStream
