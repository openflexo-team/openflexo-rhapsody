...
package org.openflexo.ta.rhapsody.fml.binding;
...
/**
 * Defines Rhapsody-specific types binding path element strategy<br>
 * 
 ...
 *
 */
public final class RPYBindingFactory extends TechnologyAdapterBindingFactory {
	static final Logger logger = Logger.getLogger(RPYBindingFactory.class.getPackage().getName());

	public RPYBindingFactory() {
		super();
	}
