 ...
 */
@ModelEntity
@ImplementationClass(value = RPYUnmappedObject.RPYUnmappedObjectImpl.class)
public interface RPYUnmappedObject extends RPYObject {
	...
	/**
	 * Default base implementation for {@link RPYUnmappedObject}
	 * 
	 * @author sylvain
	 *
	 */
