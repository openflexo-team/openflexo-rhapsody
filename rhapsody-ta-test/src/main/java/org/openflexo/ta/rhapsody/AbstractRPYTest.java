...
public abstract class AbstractRPYTest extends OpenflexoProjectAtRunTimeTestCase {
	protected static final Logger logger = Logger.getLogger(AbstractRPYTest.class.getPackage().getName());
	...
	protected RPYProjectResource getDSLResource(String documentName) {

		System.out.println("allRCS: " + serviceManager.getResourceCenterService().getResourceCenters());

		FlexoResourceCenter<?> resourceCenter = serviceManager.getResourceCenterService()
				.getFlexoResourceCenter("http://openflexo.org/rhapsody-test");
		return getRPYProjectResource(documentName, resourceCenter);
	}

	protected RPYProject getRPYProject(String documentName) {

		RPYProjectResource documentResource = getDSLResource(documentName);
		assertNotNull(documentResource);

		RPYProject document = null;
		try {
